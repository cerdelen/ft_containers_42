...
/*   Updated: 2022/09/06 19:51:58 by cerdelen         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
	...
	class map
	{
		...
		class value_compare : public std::binary_function<value_type, value_type, bool>
		{
			public:
				...
				{
					return (first._first > second._first);
				}		
		};

		public:
			// map( void );  do i need a standard constructor?
			explicit map( const key_compare & comp = key_compare(), const allocator_type &alloc = allocator_type()) : tree(comp, alloc)     //why explicit?
			{};
			~map();
